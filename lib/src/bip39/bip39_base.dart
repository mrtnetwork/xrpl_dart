...
class BIP39 {
  ...
  static String generateMnemonic({int strength = 128}) {
    ...
    final entropy = generateRandom(strength ~/ 8);
    return _entropyToMnemonic(bytesToHex(entropy));
  }
  ...
  static String _entropyToMnemonic(String entropyString) {
    ...
    String words =
        chunks.map((binary) => wordlist[binaryToByte(binary)]).join(' ');
    return words;
  }
  ...
  static String _mnemonicToEntropy(String mnemonic) {
